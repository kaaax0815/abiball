...
export type ScanResultDialogProps = {
  isOpen: boolean;
  closeModal: () => void;
  result: null | string | Record<string, string>;
};

export default function ScanResultDialog({ isOpen, closeModal, result }: ScanResultDialogProps) {
  const Result = useMemo(() => {
    ...
    if (typeof result === 'string') {
      return <ErrorText result={result} />;
    }
